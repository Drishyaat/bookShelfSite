  ...
  return (
    <>
      ...
      <div className={`modal ${applyCoupon ? "" : "modal-hide"}`}>
        <div className={`modal-container ${styles.modalContainer}`}>
          ...
          <div className={`checkbox-container ${styles.coupon}`}>
            ...
            <label
              htmlFor="coupon10"
              className={totalAmount < 10000 ? styles.couponLabel : ""}
            >
          ...
          <div className={`checkbox-container ${styles.coupon}`}>
            ...
            <label
              htmlFor="coupon15"
              className={totalAmount < 12000 ? styles.couponLabel : ""}
            >
      ...
      <div className={styles.cartPriceContainer}>
        ...
        <button
          className={`btn btn-info ${styles.couponBtn}`}
          onClick={() => setApplyCoupon(true)}
        >
          {couponType ? "Coupon Applied" : "Apply Coupon"}
        </button>
        {couponType ? (
          <span className={styles.couponType}>{couponType}%</span>
        ) : (
          ""
        )}
